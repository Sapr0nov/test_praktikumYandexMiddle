...
export class ApiAction {
  ...
  async getUser(): Promise<UserFields> {
    ...
    let req: XMLHttpRequest = (await fetch.get(
  ...
  async signUp(
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.post(
      this.BASE_URL + this.SIGNUP,
      options
    )) as XMLHttpRequest;
    return data;
  }
  ...
  async chatList(
    ...
    if (offset) {
      additionalString += "offset=" + offset + "&";
    }
    if (search) {
      additionalString += "search" + encodeURI(search) + "&";
    }
    if (limit) {
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.get(
      this.BASE_URL + this.GET_CHATS + additionalString,
      options
    )) as XMLHttpRequest;
  ...
  async updateUserInfo(info: UserFields): Promise<XMLHttpRequest> {
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.put(
      this.BASE_URL + this.UPDATE_USER,
      options
    )) as XMLHttpRequest;
  ...
  async loadAvatar(file: FormData): Promise<XMLHttpRequest> {
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.put(
      this.BASE_URL + this.LOAD_AVATAR,
      options
    )) as XMLHttpRequest;
  ...
  async updatePassword(
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.put(
      this.BASE_URL + this.UPDATE_PSWD,
      options
    )) as XMLHttpRequest;
  ...
  async createChat(title: string): Promise<XMLHttpRequest> {
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.post(
      this.BASE_URL + this.ACTION_CHAT,
      options
    )) as XMLHttpRequest;
  ...
  async deleteChat(chatId: number): Promise<XMLHttpRequest> {
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.delete(
      this.BASE_URL + this.ACTION_CHAT,
      options
    )) as XMLHttpRequest;
  ...
  async addUsersToChat(
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.put(
      this.BASE_URL + this.USERIN_CHAT,
      options
    )) as XMLHttpRequest;
  ...
  async getTokenChat(chatId: number): Promise<XMLHttpRequest> {
    ...
    const fetch = new Fetch();
    let data: XMLHttpRequest = (await fetch.post(
      this.BASE_URL + this.GET_TOKEN + "/" + chatId,
      options
    )) as XMLHttpRequest;
